...
class SettingsFragment : PreferenceFragmentCompat() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        val prefVersion = findPreference<Preference>(AppConstants.SharedPreference.APP_VERSION)
        val prefRating = findPreference<Preference>(AppConstants.SharedPreference.RATING)
        val prefFont = findPreference<ListPreference>(AppConstants.SharedPreference.FONT_SIZE_KEY)
